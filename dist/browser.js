(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["backgroundRemoval"] = factory();
	else
		root["backgroundRemoval"] = factory();
})(self, () => {
...
var bundle = new Map([
    [
        'small',
        {
            url: __webpack_require__(/*! ../bundle/models/a620c8c752bdf5c69d98.onnx */ "./bundle/models/a620c8c752bdf5c69d98.onnx"),
            size: 44342436,
    ...
    [
        'medium',
        {
            url: __webpack_require__(/*! ../bundle/models/2ebb460f4adfe0ebf34d.onnx */ "./bundle/models/2ebb460f4adfe0ebf34d.onnx"),
            size: 88188479,
            mime: 'application/octet-stream'
        }
    ],
    [
        ...
        {
            url: __webpack_require__(/*! ../node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.wasm */ "./node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.wasm"),
            size: 10281838,
    ...
    [
        'ort-wasm-simd.wasm',
        {
            url: __webpack_require__(/*! ../node_modules/onnxruntime-web/dist/ort-wasm-simd.wasm */ "./node_modules/onnxruntime-web/dist/ort-wasm-simd.wasm"),
            size: 10335238,
            mime: 'application/wasm'
        }
    ],
    [
        ...
        {
            url: __webpack_require__(/*! ../node_modules/onnxruntime-web/dist/ort-wasm-threaded.wasm */ "./node_modules/onnxruntime-web/dist/ort-wasm-threaded.wasm"),
            size: 9413659,
            mime: 'application/wasm'
        }
    ],
    [
        'ort-wasm.wasm',
        {
            url: __webpack_require__(/*! ../node_modules/onnxruntime-web/dist/ort-wasm.wasm */ "./node_modules/onnxruntime-web/dist/ort-wasm.wasm"),
            size: 9487920,
            mime: 'application/wasm'
        }
    ]
]);
function load(key, config) {
    var _a;
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        var entry, url, userConfig, defaultFetchOptions, response, chunks, _b, data;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    userConfig = (_a = config.fetchArgs) !== null && _a !== void 0 ? _a : {};
                    defaultFetchOptions = {
                        headers: {
                    ...
                    console.log({ url: url, publicPath: config.publicPath, entry: entry.url });
                    return [4 /*yield*/, fetch(url, (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)((0,tslib__WEBPACK_IMPORTED_MODULE_0__.__assign)({}, userConfig), defaultFetchOptions))];
                case 1:
                    response = _c.sent();
                    if (!config.progress) return [3 /*break*/, 3];
                    return [4 /*yield*/, fetchChunked(response, entry, config, key)];
                case 2:
                    _b = _c.sent();
                    return [3 /*break*/, 5];
...
function fetchChunked(response, entry, config, key) {
    var _a;
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        var reader, contentLength, receivedLength, chunks, _b, done, value;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_c) {
            switch (_c.label) {
                case 0:
                    reader = response.body.getReader();
                    contentLength = (_a = entry.size) !== null && _a !== void 0 ? _a : 0;
                    receivedLength = 0;
                    chunks = [];
                    _c.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    if (config.progress)
                        config.progress("fetch:".concat(key), receivedLength, contentLength);
                    return [3 /*break*/, 1];
...
function preload(config) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
            result = new Map(bundle);
            result.forEach(function (_, key) { return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(_this, void 0, void 0, function () {
                return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, load(key, config)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
...
function runInference(imageData, config, imports, session) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function () {
        var resolution, src_width, src_height, dims, tensorImage, inputTensorData, predictionsDict, stride, i, idx, alpha, _a, width, height, dst_width, dst_height;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__generator)(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    dims = [1, 3, resolution, resolution];
                    return [4 /*yield*/, (0,_utils__WEBPACK_IMPORTED_MODULE_0__.imageDataResize)(imageData, resolution, resolution)];
                case 1:
                    tensorImage = _b.sent();
                    inputTensorData = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.imageDataToFloat32Array)(tensorImage);
                    return [4 /*yield*/, imports.runSession(session, [['input', { data: inputTensorData, shape: dims, dataType: 'float32' }]], ['output'])];
                case 2:
                    predictionsDict = _b.sent();
                    stride = resolution * resolution;
                    for (i = 0; i < 4 * stride; i += 4) {
                        idx = i / 4;
                        alpha = predictionsDict[0].data[idx];
                        tensorImage.data[i + 3] = alpha * 255;
                    }
                    _a = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.calculateProportionalSize)(imageData.width, imageData.height, resolution, resolution), width = _a[0], height = _a[1];
                    dst_width = Math.min(width, src_width);
                    dst_height = Math.min(height, src_height);
                    return [4 /*yield*/, (0,_utils__WEBPACK_IMPORTED_MODULE_0__.imageDataResize)(tensorImage, dst_width, dst_height)];
                case 3:
                    tensorImage = _b.sent();
                    if (config.progress)
                        config.progress('compute:inference', 1, 1);
                    return [2 /*return*/, tensorImage];
            }
        });
    });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createOnnxRuntime: () => (/* binding */ createOnnxRuntime)
/* harmony export */ });
...
/* harmony import */ var onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! onnxruntime-web */ "./node_modules/onnxruntime-web/dist/ort.min.js");
/* harmony import */ var onnxruntime_web__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__);
...
function createOnnxRuntime(config) {
    var _this = this;
    return {
        createSession: function (model) { return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(_this, void 0, void 0, function () {
            var capabilities, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, ort_config, session;
            var _p, _q;
            var _r;
            return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__generator)(this, function (_s) {
                switch (_s.label) {
                    case 0:
                        _p = {};
                        return [4 /*yield*/, (0,wasm_feature_detect__WEBPACK_IMPORTED_MODULE_0__.simd)()];
                    case 1:
                        _p.simd = _s.sent();
                        return [4 /*yield*/, (0,wasm_feature_detect__WEBPACK_IMPORTED_MODULE_0__.threads)()];
                    case 2:
                        capabilities = (_p.threads = _s.sent(),
                            _p.SharedArrayBuffer = typeof SharedArrayBuffer !== 'undefined',
                            _p.numThreads = (_r = navigator.hardwareConcurrency) !== null && _r !== void 0 ? _r : 4,
                            // @ts-ignore
                            _p.webgpu = navigator.gpu !== undefined,
                            _p);
                        if (config.debug) {
                            console.debug('Capabilities:', capabilities);
                            onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.debug = true;
                            onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.logLevel = 'verbose';
                        }
                        onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.numThreads = capabilities.numThreads;
                        onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.simd = capabilities.simd;
                        onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.proxy = config.proxyToWorker;
                        _a = onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm;
                        _q = {};
                        _b = 'ort-wasm-simd-threaded.wasm';
                        _d = (_c = URL).createObjectURL;
                        return [4 /*yield*/, _bundle__WEBPACK_IMPORTED_MODULE_2__.load('ort-wasm-simd-threaded.wasm', config)];
                    case 3:
                        _q[_b] = _d.apply(_c, [_s.sent()]);
                        _e = 'ort-wasm-simd.wasm';
                        _g = (_f = URL).createObjectURL;
                        return [4 /*yield*/, _bundle__WEBPACK_IMPORTED_MODULE_2__.load('ort-wasm-simd.wasm', config)];
                    case 4:
                        _q[_e] = _g.apply(_f, [_s.sent()]);
                        _h = 'ort-wasm-threaded.wasm';
                        _k = (_j = URL).createObjectURL;
                        return [4 /*yield*/, _bundle__WEBPACK_IMPORTED_MODULE_2__.load('ort-wasm-threaded.wasm', config)];
                    case 5:
                        _q[_h] = _k.apply(_j, [_s.sent()]);
                        _l = 'ort-wasm.wasm';
                        _o = (_m = URL).createObjectURL;
                        return [4 /*yield*/, _bundle__WEBPACK_IMPORTED_MODULE_2__.load('ort-wasm.wasm', config)];
                    case 6:
                        _a.wasmPaths = (_q[_l] = _o.apply(_m, [_s.sent()]),
                            _q);
                        if (config.debug) {
                            console.debug('ort.env.wasm:', onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm);
                        }
                        ort_config = {
                        ...
                        return [4 /*yield*/, onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.InferenceSession.create(model, ort_config).catch(function (e) {
                                throw new Error("Failed to create session: ".concat(e, ". Please check if the publicPath is set correctly."));
                            })];
                    case 7:
                        session = _s.sent();
                        URL.revokeObjectURL(onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.wasmPaths['ort-wasm-simd-threaded.wasm']);
                        URL.revokeObjectURL(onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.wasmPaths['ort-wasm-simd.wasm']);
                        URL.revokeObjectURL(onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.wasmPaths['ort-wasm-threaded.wasm']);
                        URL.revokeObjectURL(onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.env.wasm.wasmPaths['ort-wasm.wasm']);
                        return [2 /*return*/, session];
                }
            });
        }); },
        runSession: function (session, inputs, outputs) { return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(_this, void 0, void 0, function () {
            var feeds, _i, inputs_1, _a, key, tensor, outputData, outputKVPairs, _b, outputs_1, key, output, tensor;
            return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__generator)(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        feeds = {};
                        for (_i = 0, inputs_1 = inputs; _i < inputs_1.length; _i++) {
                            _a = inputs_1[_i], key = _a[0], tensor = _a[1];
                            feeds[key] = new onnxruntime_web__WEBPACK_IMPORTED_MODULE_1__.Tensor('float32', new Float32Array(tensor.data), tensor.shape);
                        }
...
var ConfigSchema = zod__WEBPACK_IMPORTED_MODULE_1__.z
    .object({
    publicPath: zod__WEBPACK_IMPORTED_MODULE_1__.z
        .string()
        .optional()
        .describe('The public path to the wasm files and the onnx model.')
        .transform(function (val) { return (val ? (0,_utils__WEBPACK_IMPORTED_MODULE_0__.ensureAbsoluteURL)(val) : val); }),
    debug: zod__WEBPACK_IMPORTED_MODULE_1__.z
        .boolean()
        .default(false)
        .describe('Whether to enable debug logging.'),
    proxyToWorker: zod__WEBPACK_IMPORTED_MODULE_1__.z
        .boolean()
        .default(true)
        .describe('Whether to proxy inference to a web worker.'),
    fetchArgs: zod__WEBPACK_IMPORTED_MODULE_1__.z
        .optional(zod__WEBPACK_IMPORTED_MODULE_1__.z.object({}))
        .default({})
        .describe('Arguments to pass to fetch when loading the model.'),
    progress: zod__WEBPACK_IMPORTED_MODULE_1__.z
        .function()
        .args(zod__WEBPACK_IMPORTED_MODULE_1__.z.string(), zod__WEBPACK_IMPORTED_MODULE_1__.z.number(), zod__WEBPACK_IMPORTED_MODULE_1__.z.number())
        .returns(zod__WEBPACK_IMPORTED_MODULE_1__.z.undefined())
        .describe('Progress callback.')
        .optional(),
    model: zod__WEBPACK_IMPORTED_MODULE_1__.z.enum(['small', 'medium']).default('medium')
})
    .default({});
function validateConfig(config) {
    var result = ConfigSchema.parse(config !== null && config !== void 0 ? config : {});
    if (result.debug)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   calculateProportionalSize: () => (/* binding */ calculateProportionalSize),
/* harmony export */   ensureAbsoluteURL: () => (/* binding */ ensureAbsoluteURL),
/* harmony export */   imageBitmapToImageData: () => (/* binding */ imageBitmapToImageData),
/* harmony export */   imageDataResize: () => (/* binding */ imageDataResize),
/* harmony export */   imageDataToFloat32Array: () => (/* binding */ imageDataToFloat32Array),
/* harmony export */   imageDecode: () => (/* binding */ imageDecode),
/* harmony export */   imageEncode: () => (/* binding */ imageEncode),
/* harmony export */   imageSourceToImageData: () => (/* binding */ imageSourceToImageData),
...
function imageDecode(blob) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        var imageBitmap, imageData;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createImageBitmap(blob)];
                case 1:
                    imageBitmap = _a.sent();
                    imageData = imageBitmapToImageData(imageBitmap);
                    return [2 /*return*/, imageData];
            }
        });
    });
}
function imageEncode(imageData, quality, type) {
    ...
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
            ...
            return [2 /*return*/, canvas.convertToBlob({ quality: quality, type: type })];
        });
    });
}
...
function imageDataResize(imageData, newWidth, newHeight) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        var bitmap;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createImageBitmap(imageData, {
                ...
                case 1:
                    bitmap = _a.sent();
                    return [2 /*return*/, imageBitmapToImageData(bitmap)];
            }
        });
    });
}
function imageDataToFloat32Array(image, mean, std) {
    if (mean === void 0) { mean = [128, 128, 128]; }
    if (std === void 0) { std = [256, 256, 256]; }
    var imageBufferData = image.data;
    var stride = image.width * image.height;
    var float32Data = new Float32Array(3 * stride);
    // r_0, r_1, .... g_0,g_1, .... b_0
    for (var i = 0, j = 0; i < imageBufferData.length; i += 4, j += 1) {
...
function calculateProportionalSize(originalWidth, originalHeight, maxWidth, maxHeight) {
    ...
    var newWidth = Math.floor(originalWidth * scalingFactor);
    var newHeight = Math.floor(originalHeight * scalingFactor);
...
function imageSourceToImageData(image) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function () {
        var response;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(image instanceof URL)) return [3 /*break*/, 3];
                ...
                case 3:
                    ...
                    if (!(image instanceof Blob)) return [3 /*break*/, 5];
                    return [4 /*yield*/, imageDecode(image)];
                case 4:
                    image = _a.sent();
                    _a.label = 5;
...
/***/ "./bundle/models/2ebb460f4adfe0ebf34d.onnx":
/*!*************************************************!*\
  !*** ./bundle/models/2ebb460f4adfe0ebf34d.onnx ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "2ebb460f4adfe0ebf34d.onnx";

/***/ }),

/***/ "./bundle/models/a620c8c752bdf5c69d98.onnx":
/*!*************************************************!*\
  !*** ./bundle/models/a620c8c752bdf5c69d98.onnx ***!
  \*************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "a620c8c752bdf5c69d98.onnx";
...
"use strict";
module.exports = __webpack_require__.p + "5fd9e75c3bb1f31c2207.wasm";
...
"use strict";
module.exports = __webpack_require__.p + "9f4d6e330a4b1cebd316.wasm";
...
"use strict";
module.exports = __webpack_require__.p + "eac818d9d05525e8f209.wasm";
...
"use strict";
module.exports = __webpack_require__.p + "c285eb5377ad8280cf32.wasm";
...
/* harmony import */ var _inference__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./inference */ "./src/inference.ts");
/* harmony import */ var _schema__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./schema */ "./src/schema.ts");
/* harmony import */ var _ort_web_rt__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ort-web-rt */ "./src/ort-web-rt.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./src/utils.ts");
/* harmony import */ var _bundle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./bundle */ "./src/bundle.ts");
...
function createSession(config, imports) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function () {
        var model, blob, arrayBuffer, session;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    model = config.model;
                    return [4 /*yield*/, _bundle__WEBPACK_IMPORTED_MODULE_4__.load(model, config)];
                case 1:
                    blob = _a.sent();
                    return [4 /*yield*/, blob.arrayBuffer()];
                case 2:
                    arrayBuffer = _a.sent();
                    return [4 /*yield*/, imports.createSession(arrayBuffer)];
                case 3:
                    session = _a.sent();
                    return [2 /*return*/, session];
            }
...
function _init(config) {
    return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function () {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__generator)(this, function (_a) {
            switch (_a.label) {
                case 0:
                    config = (0,_schema__WEBPACK_IMPORTED_MODULE_1__.validateConfig)(config);
                    imports = (0,_ort_web_rt__WEBPACK_IMPORTED_MODULE_2__.createOnnxRuntime)(config);
                    return [4 /*yield*/, createSession(config, imports)];
                case 1:
                    session = _a.sent();
                    return [2 /*return*/, { config: config, imports: imports, session: session }];
            }
        });
    });
}
var init = lodash_memoize__WEBPACK_IMPORTED_MODULE_5___default()(_init, function (config) { return JSON.stringify(config); });
function removeBackground(image, configuration) {
    var _a;
    return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function () {
        var _b, config, imports, session, imageData;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__generator)(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _b = configuration.config, config = _b === void 0 ? {
                        debug: false,
                        proxyToWorker: false,
                        model: 'medium',
                        fetchArgs: {},
                    ...
                    } : _b, imports = configuration.imports, session = configuration.session;
                    console.log('imports', imports);
                    console.log('session', session);
                    if (config === null || config === void 0 ? void 0 : config.debug) {
                        config.progress =
                            (_a = config === null || config === void 0 ? void 0 : config.progress) !== null && _a !== void 0 ? _a : (function (key, current, total) {
                    ...
                    return [4 /*yield*/, _utils__WEBPACK_IMPORTED_MODULE_3__.imageSourceToImageData(image)];
                case 1:
                    image = _c.sent();
                    if (!(image instanceof ImageData)) {
                        throw new Error('Image not an ImageData | ArrayBuffer | Uint8Array | Blob | URL | string');
                    }
                    return [4 /*yield*/, (0,_inference__WEBPACK_IMPORTED_MODULE_0__.runInference)(image, config, imports, session)];
                case 2:
                    imageData = _c.sent();
                    return [4 /*yield*/, _utils__WEBPACK_IMPORTED_MODULE_3__.imageEncode(imageData)];
                case 3: return [2 /*return*/, _c.sent()];
            }
        });
    });
}
var BackgroundRemoval = /** @class */ (function () {
    function BackgroundRemoval(config) {
        this.controller = null;
        this.imglyProcessor = null;
        this.config = null;
        this.loaded = false;
        this.config = config;
        this.controller =  false || new AbortController();
        this.imglyProcessor = null;
        this.loaded = false;
    }
    BackgroundRemoval.prototype.loadModel = function () {
        var _a;
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function () {
            var _b;
            return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__generator)(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        this.loaded = true;
                        _b = this;
                        return [4 /*yield*/, init(this.config || undefined)];
                    case 1:
                        _b.imglyProcessor = _c.sent();
                        return [2 /*return*/, this.imglyProcessor];
                }
            });
        });
    };
    BackgroundRemoval.prototype.warmpUp = function () {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function () {
            return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__generator)(this, function (_a) {
                switch (_a.label) {
    ...
    ;
    BackgroundRemoval.prototype.removeBackground = function (image) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function () {
            var imglyProcessor, signal, result;
            return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__generator)(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        imglyProcessor = _a.sent();
                        this.controller = new AbortController();
                        signal = this.controller.signal;
                        console.log('signal', signal);
                        return [4 /*yield*/, removeBackground(image, imglyProcessor)];
                    case 2:
                        result = _a.sent();
                        this.controller = null;
                        return [2 /*return*/, result];
    ...
    BackgroundRemoval.prototype.cancelBackgroundRemoval = function () {
        if (this.controller) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BackgroundRemoval);
